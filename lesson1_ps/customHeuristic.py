...
def custom_heuristic(file_path):
    ...
    passenger_id = passenger['PassengerId']c
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        if (passenger.Age >= 0 and passenger.Age < 7):
            predictions[passenger_id] = 1
...
filepath = '/home/laura/Documents/DataScience/Nanodegree/dataScience/lesson1_ps/titanic_data.csv'
print custom_heuristic(filepath)
